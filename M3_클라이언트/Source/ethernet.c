...
uint8_t Dest_IP[4] = {192, 168, 0, 4}; //DST_IP Address
uint16_t Dest_PORT = 25000;
...
//			setSn_CR(s, Sn_CR_RECV);
	...
	case SOCK_CLOSED:                                               /* if a socket is closed */
		...
		if(socket(s, Sn_MR_TCP, any_port++, 0x00) != s)    		/* reinitialize the socket */
		{
